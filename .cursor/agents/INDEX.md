...
- Check `docs/PROJECT_STATUS.md` when you need to know the current project status, what is being worked on, or what the backlog contains.
- **Keep `docs/PROJECT_STATUS.md` updated.** When you start or complete work, update the "Currently In Progress" and "Backlog" sections to reflect the current state.
