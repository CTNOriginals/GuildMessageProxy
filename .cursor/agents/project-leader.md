...
3. For each subagent task: use `.cursor/skills/compose-prompt` to optimize the prompt; specify exact file paths; tell subagents to skip explanations and return only output summaries
